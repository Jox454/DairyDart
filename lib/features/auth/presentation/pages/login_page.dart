                        ...
                        children: [
                              ...
                              onChanged: (value) {
                                if (value.length >= 25) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(content: Text("Email reached maximum length (25)"), duration: Duration(seconds: 1)),
                                  );
                                }
                              },
                          ...
                          GlassCard(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                // Double check if any special character somehow slipped in
                                final alphanumeric = RegExp(r'^[a-zA-Z0-9]*$');
                                setState(() {
                                  if (!alphanumeric.hasMatch(value)) {
                                    _passwordError = "Only letters and numbers allowed!";
                                  } else {
                                    _passwordError = null;
                                  }
                                });
                              ...
                              decoration: InputDecoration(
                                ...
                                helperStyle: const TextStyle(color: AppColors.outline, fontSize: 10),
